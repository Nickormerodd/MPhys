# -*- coding: utf-8 -*-
"""
Created on Wed Apr 17 14:46:41 2024
...
def plotting(line_map, continuum, blue, red, hdul):
    ...
    #plt.contour(xx_c,yy_c,continuum_2d, levels = 8, alpha = 0.5, cmap='Greys',
    #            linewidths = 0.7, label = 'Continuum contours')
    ...
    plt.colorbar(pig, label='km/s')
    plt.xlabel("GLON", size=12)
    plt.ylabel("GLAT", size=12)

    
    plt.title('Velocity Map CH$_{3}$CN', size=13)
    name = OUT + 'Velocity_con_CH3CN.pdf'
